...
.....................................
	*/
	 ...
	 */
	 ...
	 %cas1: profondeur maximale atteinte.
negamax(J,Etat,Pmax,Pmax,[rien,H]):-
    heuristique(J,Etat,H).
    %cas2: P<Pmax et tableau complet
negamax(J,Etat,P,Pmax,[rien,H]):-
    P<Pmax,
    ground(Etat),
    heuristique(J,Etat,H).
    
    %cas3 : P<Pmax et tableau non complet (situation non terminale)
...
main(B,V,Pmax) :-
    situation_initiale(Init),
    joueur_initial(J),
    negamax(J,Init,1,Pmax,[B,V]).
